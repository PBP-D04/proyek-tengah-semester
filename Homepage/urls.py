...
from .views import home, proxy_endpoint,get_books_json,like_or_dislike_book,get_books, all_books_page, get_categories, get_dummy_message, search_page, search_books_json,advanced_search
app_name = 'Homepage'
