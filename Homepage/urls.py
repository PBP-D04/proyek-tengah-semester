...
from .views import home, get_books_json, all_books_page, get_categories, search_category_page,search_page, search_books_json,search_books_json_category,advanced_search
app_name = 'Homepage'
